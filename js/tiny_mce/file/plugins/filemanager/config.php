<?php
	...
	$mcFileManagerConfig['general.disabled_tools'] = "createdoc";
	...
	$mcFileManagerConfig['filesystem.path'] = '../../../../pages/files'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = 'Files=../../../../pages/files;Images=../../../../images/content'; // absolute or relative from this script path.
	...
	// Upload options
	$mcFileManagerConfig['upload.maxsize'] = "60MB";
	...
	//$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,txt,htm,html";
	...
	$mcFileManagerConfig['authenticator.login_page'] = "../../../../index.php";
	$mcFileManagerConfig['authenticator.allow_override'] = "*";

	// SessionAuthenticator
	$mcFileManagerConfig['SessionAuthenticator.logged_in_key'] = "MM_logged";
	//$mcFileManagerConfig['SessionAuthenticator.groups_key'] = "groups";
	$mcFileManagerConfig['SessionAuthenticator.user_key'] = "MM_Username";
