<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../images/content'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['authenticator.login_page'] = "../../../../index.php";
	$mcImageManagerConfig['authenticator.allow_override'] = "*";

	// SessionAuthenticator
	$mcImageManagerConfig['SessionAuthenticator.logged_in_key'] = "MM_logged";
	//$mcImageManagerConfig['SessionAuthenticator.groups_key'] = "groups";
	$mcImageManagerConfig['SessionAuthenticator.user_key'] = "MM_Username";
